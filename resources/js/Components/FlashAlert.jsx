...
const FlashAlert = ({ flash }) => {
    const [alert, setAlert] = useState(!!flash.success || !!flash.warning);

    useEffect(() => {
        setAlert(!!flash.success || !!flash.warning);
                        ...
                        <div className="p-4">
                            <div className="flex items-start">
                                ...
                                <div className="ml-3 w-0 flex-1 pt-0.5">
                                    ...
                                    <p className="mt-1 text-sm text-gray-500">{flash.success || flash.warning}</p>
                                </div>
