        ...
        <>
            <div className=' bg-gray-50'>
                ...
                <div className="lg:pl-72 min-h-screen">
                    <div className="sticky top-0 z-40 lg:mx-auto lg:max-w-7xl lg:px-8 border-gray-200 bg-white">
                        <div className="flex h-16 items-center gap-x-4 border-bpx-4 shadow-sm sm:gap-x-6 sm:px-6 lg:px-0 lg:shadow-none px-4">
                            <button
                                type="button"
